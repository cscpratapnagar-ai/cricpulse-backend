...
echo "============================================================"
echo " CRICPULSE RUN_OUT + 7 RUNS + NEW BATTER E2E - REPOSITORY VERIFIED"
echo "============================================================"
echo
...
[[ "$AFTER_RUNS" -eq $((RUNS + BAT_RUNS)) ]] && echo "[PASS] Team score increased by 7 runs" || { echo "[FAIL] Team score mismatch after RUN_OUT + 7 runs" >&2; exit 1; }
...
echo
echo "============================================================"
echo " RUN_OUT + 7 RUNS + NEW BATTER E2E PASSED"
echo "============================================================"
echo
