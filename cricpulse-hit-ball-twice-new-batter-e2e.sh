...
# CricPulse HIT_BALL_TWICE + NEW BATTER E2E.
...
echo "============================================================"
echo " CRICPULSE HIT_BALL_TWICE + NEW BATTER E2E - REPOSITORY VERIFIED"
echo "============================================================"
echo
...
echo "== 3. RECORD HIT_BALL_TWICE WICKET =="
BEFORE_LEGAL=$LEGAL
...
if [[ "$RECORD_HTTP" != "200" ]]; then
  echo "[FAIL] Record HIT_BALL_TWICE wicket (HTTP $RECORD_HTTP)" >&2
  echo "$RECORD_JSON" >&2
  exit 1
fi
echo "[PASS] Record HIT_BALL_TWICE wicket (HTTP 200)"
...
[[ "$AFTER_WICKETS" -eq $((WICKETS + 1)) ]] && echo "[PASS] HIT_BALL_TWICE wicket count +1" || { echo "[FAIL] Wicket count did not increment" >&2; exit 1; }
...
[[ "$DISMISSAL" == "$WICKET_TYPE" ]] && echo "[PASS] Dismissed batter marked HIT_BALL_TWICE" || { echo "[FAIL] Dismissed batter dismissal type mismatch" >&2; exit 1; }
[[ "$FOW_COUNT" -ge $((WICKETS + 1)) ]] && echo "[PASS] Fall of wicket recorded" || { echo "[FAIL] Fall of wicket not recorded" >&2; exit 1; }
[[ -n "$RECENT_WICKET" ]] && echo "[PASS] Recent delivery contains HIT_BALL_TWICE wicket" || { echo "[FAIL] Recent delivery missing HIT_BALL_TWICE" >&2; exit 1; }

echo
echo "============================================================"
echo " HIT_BALL_TWICE + NEW BATTER E2E PASSED"
echo "============================================================"
echo
