...
echo "============================================================"
echo " CRICPULSE RUN_OUT + 1 RUN + NEW BATTER E2E - REPOSITORY VERIFIED"
echo "============================================================"
echo
...
if [[ "$RECORD_HTTP" != "200" ]]; then echo "[FAIL] Record RUN_OUT + 1 run (HTTP $RECORD_HTTP)" >&2; echo "$RECORD_JSON" >&2; exit 1; fi
echo "[PASS] Record RUN_OUT + 1 run (HTTP 200)"
...
[[ "$AFTER_RUNS" -eq $((RUNS + BAT_RUNS)) ]] && echo "[PASS] Team score increased by 1 run" || { echo "[FAIL] Team score mismatch after RUN_OUT + run" >&2; exit 1; }
[[ "$AFTER_STRIKER" == "$NEW_BATTER" ]] && echo "[PASS] New batter correctly occupies striker end after crossing" || { echo "[FAIL] New batter strike position incorrect" >&2; exit 1; }
...
echo
echo "============================================================"
echo " RUN_OUT + 1 RUN + NEW BATTER E2E PASSED"
echo "============================================================"
echo
