...
echo "============================================================"
echo " CRICPULSE RUN_OUT + 6 RUNS + NEW BATTER E2E - REPOSITORY VERIFIED"
echo "============================================================"
echo
...
if [[ "$RECORD_HTTP" != "200" ]]; then echo "[FAIL] Record RUN_OUT + 6 runs (HTTP $RECORD_HTTP)" >&2; echo "$RECORD_JSON" >&2; exit 1; fi
echo "[PASS] Record RUN_OUT + 6 runs (HTTP 200)"
...
[[ "$AFTER_RUNS" -eq $((RUNS + BAT_RUNS)) ]] && echo "[PASS] Team score increased by 6 runs" || { echo "[FAIL] Team score mismatch after RUN_OUT + 6 runs" >&2; exit 1; }
...
echo
echo "============================================================"
echo " RUN_OUT + 6 RUNS + NEW BATTER E2E PASSED"
echo "============================================================"
echo
